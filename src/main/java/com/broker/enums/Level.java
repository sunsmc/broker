...
public enum Level {
    ...
    OA(1, "普通", BigDecimal.valueOf(0.01),
    ...
    BE(2, "主任", BigDecimal.valueOf(0.03),
    ...
    BM(3, "经理", BigDecimal.valueOf(0.05),
    ...
    BD(4, "总监", BigDecimal.valueOf(0.07),
    ...
    CF(5, "联创", BigDecimal.valueOf(0.09),
